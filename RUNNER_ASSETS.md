...
Оригинал проигрывает эти последовательности через Pixi `AnimatedSprite`. На странице нет готовых Cocos `.anim`: для создания Clip в Cocos используйте WebP-кадры в порядке из `animation-index.json` и указанный FPS. GIF-файлы служат превью.
